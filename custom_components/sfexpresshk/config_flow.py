...
class SFExpressOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        defaults = {
            CONF_PHONE_NUMBER: self._config_entry.data.get(CONF_PHONE_NUMBER, "95451403"),
            CONF_MEMBER_ID: self._config_entry.data.get(CONF_MEMBER_ID, "BB28ECC282B344A78C52E8410860C81D"),
            "screensize": self._config_entry.data.get("screensize", "1080x2400"),
            "mediacode": self._config_entry.data.get("mediacode", "AndrHMTO"),
            "systemversion": self._config_entry.data.get("systemversion", "15"),
            "clientversion": self._config_entry.data.get("clientversion", "2.79.0"),
            "model": self._config_entry.data.get("model", "Pixel 7"),
            "deviceid": self._config_entry.data.get("deviceid", "929206ca-65b1-3642-9fc4-6de68b86694c"),
            "jsbundle": self._config_entry.data.get("jsbundle", "5b82ae1681c44eb7c1c72d1a0f842860"),
            CONF_SFBUY_TICKET: self._config_entry.data.get(CONF_SFBUY_TICKET, "UNIT1_A2_1c023d51ccc5b076fc84f51e5aeb78601737261283816"),
        }
